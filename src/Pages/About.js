...
export default function about() {
    ...
    <div>
         ...
         <p className="aboutElement">At Nana, we're commited to ofering top-quality Japanese cuisine and a warm, inviting dining experience. Since our opeing, we've focused on perfecting traditional
